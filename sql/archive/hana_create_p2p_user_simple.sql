-- ============================================
-- SAP HANA Cloud P2P Development User Setup (Simplified)
-- ============================================
...
-- Step 1: Create P2P Development User
...
-- Step 3: Grant System Privileges Directly to User
...
-- Step 5: Grant Full Schema Privileges to User
...
-- Step 8: Create Additional P2P Schemas (Optional)
...
-- Step 11: Verify Schema Ownership
SELECT 
    SCHEMA_NAME,
    SCHEMA_OWNER,
    CREATE_TIME
...
-- Step 12: Test Connection Ability
-- User should now be able to:
-- 1. Connect to the database
-- 2. Create tables, views, procedures in P2P_SCHEMA
-- 3. Import/Export data
-- 4. Read system catalog
