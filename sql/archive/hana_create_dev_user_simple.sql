-- ============================================
-- SAP HANA Cloud Development User Setup (Simplified)
-- ============================================
...
-- Step 4: Create Development Schema
...
-- Step 9: Verify Granted Privileges
SELECT 
    GRANTEE,
    PRIVILEGE,
    GRANTOR,
...
-- Step 10: Test Connection Ability
-- User should now be able to:
-- 1. Connect to the database
-- 2. Create tables, views, procedures in DEV_SCHEMA
