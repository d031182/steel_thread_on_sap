...
**Related**: [[feng-shui-preview-mode-design]], [[high-46.5-preview-mode-parser-implementation]], [[high-46.6-preview-mode-ai-integration]], [[high-46.7-preview-mode-cicd-integration]]
...
- **[[high-46.5-preview-mode-parser-implementation]]** - Document parser technical details
- **[[high-46.6-preview-mode-ai-integration]]** - AI integration hooks
- **[[high-46.7-preview-mode-cicd-integration]]** - CI/CD setup guide
...
4. **Read design doc**: [[feng-shui-preview-mode-design]]
5. **Check technical README**: `tools/fengshui/preview/README.md`

---

**Questions?** See [[feng-shui-preview-mode-design]] or the technical README at `tools/fengshui/preview/README.md`