# Feng Shui Enhancement Proposal: _detect_detector__detect_nested_loops

**Proposal ID**: 20260214-FILE-detector_n  
**Date**: 2026-02-14  
**Status**: PROPOSED  
**Priority**: P2 (MEDIUM)  
...
Detector _detect_nested_loops has no corresponding unit test
...
### 1. Detector: `_detect_detector__detect_nested_loops`

**What It Detects**:
Issues related to: Detector _detect_nested_loops has no corresponding unit test
...
- `tools/fengshui/agents/fileorganization_agent.py`
  - Add _detect_detector__detect_nested_loops method
  - Update analyze_module() to call new detector

**Files to Create**:

- `tests/unit/tools/fengshui/test_detect_detector__detect_nested_loops.py` - Unit tests for detector

### 3. Testing Plan

**Unit Tests**:
- File: `tests/unit/tools/fengshui/test__detect_detector__detect_nested_loops.py`
