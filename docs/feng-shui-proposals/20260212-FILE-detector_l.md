# Feng Shui Enhancement Proposal: _detect_detector__detect_large_classes

**Proposal ID**: 20260212-FILE-detector_l  
**Date**: 2026-02-12  
**Status**: PROPOSED  
**Priority**: P2 (MEDIUM)  
...
Detector _detect_large_classes has no corresponding unit test
...
### 1. Detector: `_detect_detector__detect_large_classes`

**What It Detects**:
Issues related to: Detector _detect_large_classes has no corresponding unit test
...
- `tools/fengshui/agents/fileorganization_agent.py`
  - Add _detect_detector__detect_large_classes method
  - Update analyze_module() to call new detector

**Files to Create**:

- `tests/unit/tools/fengshui/test_detect_detector__detect_large_classes.py` - Unit tests for detector

### 3. Testing Plan

**Unit Tests**:
- File: `tests/unit/tools/fengshui/test__detect_detector__detect_large_classes.py`
