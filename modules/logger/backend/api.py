"""
Application Logger REST API
============================
Flask Blueprint providing REST API for log management.
...
def create_blueprint():
    """
    Create Flask Blueprint for logger API
    
    Returns:
        Flask Blueprint with all log management endpoints
    """
    bp = Blueprint('logger_api', __name__)
    logger = logging.getLogger(__name__)
    
    # Get logging service (injected by app)
    def get_logging_service():
        """Get logging service from Flask app context"""
        from flask import current_app
        return current_app.logging_service
    ...
    def get_logs():
        ...
        try:
            ...
            total_count = logging_service.get_log_count(level=level)
    ...
    def log_client_error():
        ...
        Captures JavaScript errors, warnings, and logs from the frontend
