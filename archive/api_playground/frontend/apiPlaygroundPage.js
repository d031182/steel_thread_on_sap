...
export function createAPIPlaygroundPage() {
    return new sap.m.VBox({
        ...
        items: [
            ...
            }).addStyleClass("sapUiSmallMarginTop").addStyleClass("apiPlaygroundFCL")
        ]
            ...
            new sap.m.VBox({
                items: [
                    ...
                    new sap.m.Select({
                        ...
                        width: "200px",
                        items: [
                            new sap.ui.core.Item({ key: "GET", text: "GET" }),
                            new sap.ui.core.Item({ key: "POST", text: "POST" }),
                            new sap.ui.core.Item({ key: "PUT", text: "PUT" }),
                            new sap.ui.core.Item({ key: "DELETE", text: "DELETE" })
                        ],
                        selectedKey: "GET"
